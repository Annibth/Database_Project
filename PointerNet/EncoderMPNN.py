...
x = torch.tensor([[1, 2], [4, 5], [7, 9], [ 11, 12], [13, 15]], dtype=torch.float)
...
# Hyperparameter
in_channels = 2   # Anzahl der Features pro Knoten
hidden_channels = 64  # Verborgene Kanäle
out_channels = 128   # Ausgangskanäle
